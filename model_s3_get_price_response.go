...
// checks if the S3GetPriceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3GetPriceResponse{}
...
func (o S3GetPriceResponse) ToMap() (map[string]interface{}, error) {
