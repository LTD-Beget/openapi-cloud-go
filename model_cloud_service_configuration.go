...
// checks if the CloudServiceConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudServiceConfiguration{}
...
type CloudServiceConfiguration struct {
	...
	NetworkDrive *NetworkDriveNetworkDriveConfiguration `json:"network_drive,omitempty"`
}
...
func (o *CloudServiceConfiguration) GetNetworkDrive() NetworkDriveNetworkDriveConfiguration {
	if o == nil || IsNil(o.NetworkDrive) {
		var ret NetworkDriveNetworkDriveConfiguration
		return ret
	}
...
// SetNetworkDrive gets a reference to the given NetworkDriveNetworkDriveConfiguration and assigns it to the NetworkDrive field.
...
func (o CloudServiceConfiguration) ToMap() (map[string]interface{}, error) {
