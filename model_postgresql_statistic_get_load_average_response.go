...
// checks if the PostgresqlStatisticGetLoadAverageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlStatisticGetLoadAverageResponse{}
...
func (o PostgresqlStatisticGetLoadAverageResponse) ToMap() (map[string]interface{}, error) {
