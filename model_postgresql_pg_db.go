...
// checks if the PostgresqlPgDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgDb{}
...
func (o PostgresqlPgDb) ToMap() (map[string]interface{}, error) {
