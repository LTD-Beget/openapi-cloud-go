...
// checks if the PostgresqlPgRemoveDbResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgRemoveDbResponseError{}
...
func (o PostgresqlPgRemoveDbResponseError) ToMap() (map[string]interface{}, error) {
