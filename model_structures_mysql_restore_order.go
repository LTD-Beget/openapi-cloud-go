...
// checks if the StructuresMysqlRestoreOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresMysqlRestoreOrder{}
...
func (o StructuresMysqlRestoreOrder) ToMap() (map[string]interface{}, error) {
