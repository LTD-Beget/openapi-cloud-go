...
// checks if the MysqlConfigInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlConfigInfo{}
...
func (o MysqlConfigInfo) ToMap() (map[string]interface{}, error) {
