...
// checks if the MysqlStatisticGetLoadAverageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetLoadAverageResponse{}
...
func (o MysqlStatisticGetLoadAverageResponse) ToMap() (map[string]interface{}, error) {
