...
// checks if the S3ChangeCorsResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ChangeCorsResponseError{}
...
func (o S3ChangeCorsResponseError) ToMap() (map[string]interface{}, error) {
