...
// checks if the CloudChangeConfigurationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudChangeConfigurationRequest{}
...
func (o CloudChangeConfigurationRequest) ToMap() (map[string]interface{}, error) {
