...
// checks if the MysqlMysql84 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlMysql84{}
...
func (o MysqlMysql84) ToMap() (map[string]interface{}, error) {
