...
// checks if the MysqlCreateDbRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlCreateDbRequest{}
...
func (o MysqlCreateDbRequest) ToMap() (map[string]interface{}, error) {
