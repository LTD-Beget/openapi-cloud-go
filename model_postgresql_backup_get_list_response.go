...
// checks if the PostgresqlBackupGetListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlBackupGetListResponse{}
...
func (o PostgresqlBackupGetListResponse) ToMap() (map[string]interface{}, error) {
