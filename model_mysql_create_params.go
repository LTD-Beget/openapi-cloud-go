...
// checks if the MysqlCreateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlCreateParams{}
...
func (o MysqlCreateParams) ToMap() (map[string]interface{}, error) {
