...
// checks if the S3EnableFtpRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3EnableFtpRequest{}
...
func (o S3EnableFtpRequest) ToMap() (map[string]interface{}, error) {
