...
// checks if the StructuresStatisticSeriesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresStatisticSeriesData{}
...
func (o StructuresStatisticSeriesData) ToMap() (map[string]interface{}, error) {
