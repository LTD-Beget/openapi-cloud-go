...
// checks if the PostgresqlPgCreateDbResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgCreateDbResponse{}
...
func (o PostgresqlPgCreateDbResponse) ToMap() (map[string]interface{}, error) {
