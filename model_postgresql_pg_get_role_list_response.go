...
// checks if the PostgresqlPgGetRoleListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgGetRoleListResponse{}
...
func (o PostgresqlPgGetRoleListResponse) ToMap() (map[string]interface{}, error) {
