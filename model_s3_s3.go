...
// checks if the S3S3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3S3{}
...
type S3S3 struct {
	...
	AttachedCdn *S3S3Cdn `json:"attached_cdn,omitempty"`
}
...
// GetAttachedCdn returns the AttachedCdn field value if set, zero value otherwise.
func (o *S3S3) GetAttachedCdn() S3S3Cdn {
	if o == nil || IsNil(o.AttachedCdn) {
		var ret S3S3Cdn
		return ret
	}
	return *o.AttachedCdn
}

// GetAttachedCdnOk returns a tuple with the AttachedCdn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *S3S3) GetAttachedCdnOk() (*S3S3Cdn, bool) {
	if o == nil || IsNil(o.AttachedCdn) {
		return nil, false
	}
	return o.AttachedCdn, true
}
...
// SetAttachedCdn gets a reference to the given S3S3Cdn and assigns it to the AttachedCdn field.
...
func (o S3S3) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AttachedCdn) {
		toSerialize["attached_cdn"] = o.AttachedCdn
	}
