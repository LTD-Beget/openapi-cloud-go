...
// checks if the PostgresqlPgCreateDbRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgCreateDbRequest{}
...
func (o PostgresqlPgCreateDbRequest) ToMap() (map[string]interface{}, error) {
