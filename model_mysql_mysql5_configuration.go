...
// checks if the MysqlMysql5Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlMysql5Configuration{}
...
func (o MysqlMysql5Configuration) ToMap() (map[string]interface{}, error) {
