...
// checks if the CloudGetConfigurationListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudGetConfigurationListResponse{}
...
func (o CloudGetConfigurationListResponse) ToMap() (map[string]interface{}, error) {
