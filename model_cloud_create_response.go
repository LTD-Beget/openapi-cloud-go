...
type CloudCreateResponse struct {
	...
	NetworkDriveError *NetworkDriveNetworkDriveCreateError `json:"network_drive_error,omitempty"`
}
...
// GetNetworkDriveError returns the NetworkDriveError field value if set, zero value otherwise.
func (o *CloudCreateResponse) GetNetworkDriveError() NetworkDriveNetworkDriveCreateError {
	if o == nil || IsNil(o.NetworkDriveError) {
		var ret NetworkDriveNetworkDriveCreateError
		return ret
	}
	return *o.NetworkDriveError
}

// GetNetworkDriveErrorOk returns a tuple with the NetworkDriveError field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudCreateResponse) GetNetworkDriveErrorOk() (*NetworkDriveNetworkDriveCreateError, bool) {
	if o == nil || IsNil(o.NetworkDriveError) {
		return nil, false
	}
	return o.NetworkDriveError, true
}
...
// SetNetworkDriveError gets a reference to the given NetworkDriveNetworkDriveCreateError and assigns it to the NetworkDriveError field.
func (o *CloudCreateResponse) SetNetworkDriveError(v NetworkDriveNetworkDriveCreateError) {
	o.NetworkDriveError = &v
}
...
func (o CloudCreateResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkDriveError) {
		toSerialize["network_drive_error"] = o.NetworkDriveError
	}
