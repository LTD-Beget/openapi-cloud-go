...
// checks if the MysqlStatisticGetDiskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetDiskResponse{}
...
func (o MysqlStatisticGetDiskResponse) ToMap() (map[string]interface{}, error) {
