...
// checks if the CdnGetPriceResponseCdn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CdnGetPriceResponseCdn{}
...
func (o CdnGetPriceResponseCdn) ToMap() (map[string]interface{}, error) {
