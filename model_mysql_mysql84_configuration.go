...
// checks if the MysqlMysql84Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlMysql84Configuration{}
...
func (o MysqlMysql84Configuration) ToMap() (map[string]interface{}, error) {
