...
// checks if the PostgresqlBackupRestoreRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlBackupRestoreRequest{}
...
func (o PostgresqlBackupRestoreRequest) ToMap() (map[string]interface{}, error) {
