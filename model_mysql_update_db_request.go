...
// checks if the MysqlUpdateDbRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlUpdateDbRequest{}
...
func (o MysqlUpdateDbRequest) ToMap() (map[string]interface{}, error) {
