...
// checks if the MysqlChangeAccessPasswordResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlChangeAccessPasswordResponseError{}
...
func (o MysqlChangeAccessPasswordResponseError) ToMap() (map[string]interface{}, error) {
