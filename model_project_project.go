...
// checks if the ProjectProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectProject{}
...
func (o ProjectProject) ToMap() (map[string]interface{}, error) {
