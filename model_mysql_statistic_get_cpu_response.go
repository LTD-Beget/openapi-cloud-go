...
// checks if the MysqlStatisticGetCpuResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetCpuResponse{}
...
func (o MysqlStatisticGetCpuResponse) ToMap() (map[string]interface{}, error) {
