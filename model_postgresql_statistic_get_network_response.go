...
// checks if the PostgresqlStatisticGetNetworkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlStatisticGetNetworkResponse{}
...
func (o PostgresqlStatisticGetNetworkResponse) ToMap() (map[string]interface{}, error) {
