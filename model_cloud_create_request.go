...
type CloudCreateRequest struct {
	...
	NetworkDriveParams *NetworkDriveNetworkDriveCreateParams `json:"network_drive_params,omitempty"`
	Extra *string `json:"extra,omitempty"`
	Region *string `json:"region,omitempty"`
	ProjectId *string `json:"project_id,omitempty"`
	UiPinned *bool `json:"ui_pinned,omitempty"`
	UiPinnedAfterRank *string `json:"ui_pinned_after_rank,omitempty"`
	UiPinnedBeforeRank *string `json:"ui_pinned_before_rank,omitempty"`
}
...
// GetNetworkDriveParams returns the NetworkDriveParams field value if set, zero value otherwise.
func (o *CloudCreateRequest) GetNetworkDriveParams() NetworkDriveNetworkDriveCreateParams {
	if o == nil || IsNil(o.NetworkDriveParams) {
		var ret NetworkDriveNetworkDriveCreateParams
		return ret
	}
	return *o.NetworkDriveParams
}

// GetNetworkDriveParamsOk returns a tuple with the NetworkDriveParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudCreateRequest) GetNetworkDriveParamsOk() (*NetworkDriveNetworkDriveCreateParams, bool) {
	if o == nil || IsNil(o.NetworkDriveParams) {
		return nil, false
	}
	return o.NetworkDriveParams, true
}
...
// SetNetworkDriveParams gets a reference to the given NetworkDriveNetworkDriveCreateParams and assigns it to the NetworkDriveParams field.
func (o *CloudCreateRequest) SetNetworkDriveParams(v NetworkDriveNetworkDriveCreateParams) {
	o.NetworkDriveParams = &v
}
...
// GetUiPinnedAfterRank returns the UiPinnedAfterRank field value if set, zero value otherwise.
func (o *CloudCreateRequest) GetUiPinnedAfterRank() string {
	if o == nil || IsNil(o.UiPinnedAfterRank) {
		var ret string
		return ret
	}
	return *o.UiPinnedAfterRank
}

// GetUiPinnedAfterRankOk returns a tuple with the UiPinnedAfterRank field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudCreateRequest) GetUiPinnedAfterRankOk() (*string, bool) {
	if o == nil || IsNil(o.UiPinnedAfterRank) {
		return nil, false
	}
	return o.UiPinnedAfterRank, true
}
...
// SetUiPinnedAfterRank gets a reference to the given string and assigns it to the UiPinnedAfterRank field.
func (o *CloudCreateRequest) SetUiPinnedAfterRank(v string) {
	o.UiPinnedAfterRank = &v
}

// GetUiPinnedBeforeRank returns the UiPinnedBeforeRank field value if set, zero value otherwise.
func (o *CloudCreateRequest) GetUiPinnedBeforeRank() string {
	if o == nil || IsNil(o.UiPinnedBeforeRank) {
		var ret string
		return ret
	}
	return *o.UiPinnedBeforeRank
}

// GetUiPinnedBeforeRankOk returns a tuple with the UiPinnedBeforeRank field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudCreateRequest) GetUiPinnedBeforeRankOk() (*string, bool) {
	if o == nil || IsNil(o.UiPinnedBeforeRank) {
		return nil, false
	}
	return o.UiPinnedBeforeRank, true
}
...
// SetUiPinnedBeforeRank gets a reference to the given string and assigns it to the UiPinnedBeforeRank field.
func (o *CloudCreateRequest) SetUiPinnedBeforeRank(v string) {
	o.UiPinnedBeforeRank = &v
}
...
func (o CloudCreateRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkDriveParams) {
		toSerialize["network_drive_params"] = o.NetworkDriveParams
	}
	if !IsNil(o.Extra) {
	...
	if !IsNil(o.UiPinnedAfterRank) {
		toSerialize["ui_pinned_after_rank"] = o.UiPinnedAfterRank
	}
	if !IsNil(o.UiPinnedBeforeRank) {
		toSerialize["ui_pinned_before_rank"] = o.UiPinnedBeforeRank
	}
