...
// checks if the MysqlMysql8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlMysql8{}
...
func (o MysqlMysql8) ToMap() (map[string]interface{}, error) {
