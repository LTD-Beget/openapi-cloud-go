...
// checks if the PostgresqlPgSetConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgSetConfigResponse{}
...
func (o PostgresqlPgSetConfigResponse) ToMap() (map[string]interface{}, error) {
