...
// checks if the S3ChangeAccessKeyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ChangeAccessKeyRequest{}
...
func (o S3ChangeAccessKeyRequest) ToMap() (map[string]interface{}, error) {
