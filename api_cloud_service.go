...
type ApiCloudServiceBindProjectRequest struct {
	ctx context.Context
	ApiService *CloudServiceApiService
	serviceId string
	cloudBindProjectRequest *CloudBindProjectRequest
}

func (r ApiCloudServiceBindProjectRequest) CloudBindProjectRequest(cloudBindProjectRequest CloudBindProjectRequest) ApiCloudServiceBindProjectRequest {
	r.cloudBindProjectRequest = &cloudBindProjectRequest
	return r
}

func (r ApiCloudServiceBindProjectRequest) Execute() (*CloudBindProjectResponse, *http.Response, error) {
	return r.ApiService.CloudServiceBindProjectExecute(r)
}

/*
CloudServiceBindProject Method for CloudServiceBindProject

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serviceId
 @return ApiCloudServiceBindProjectRequest
*/
func (a *CloudServiceApiService) CloudServiceBindProject(ctx context.Context, serviceId string) ApiCloudServiceBindProjectRequest {
	return ApiCloudServiceBindProjectRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
...
//  @return CloudBindProjectResponse
func (a *CloudServiceApiService) CloudServiceBindProjectExecute(r ApiCloudServiceBindProjectRequest) (*CloudBindProjectResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CloudBindProjectResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudServiceApiService.CloudServiceBindProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/cloud/{service_id}/project"
	localVarPath = strings.Replace(localVarPath, "{"+"service_id"+"}", url.PathEscape(parameterToString(r.serviceId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cloudBindProjectRequest == nil {
		return localVarReturnValue, nil, reportError("cloudBindProjectRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cloudBindProjectRequest
...
type ApiCloudServiceChangePinnedRequest struct {
	ctx context.Context
	ApiService *CloudServiceApiService
	serviceId string
	cloudChangePinnedRequest *CloudChangePinnedRequest
}

func (r ApiCloudServiceChangePinnedRequest) CloudChangePinnedRequest(cloudChangePinnedRequest CloudChangePinnedRequest) ApiCloudServiceChangePinnedRequest {
	r.cloudChangePinnedRequest = &cloudChangePinnedRequest
	return r
}

func (r ApiCloudServiceChangePinnedRequest) Execute() (*CloudChangePinnedResponse, *http.Response, error) {
	return r.ApiService.CloudServiceChangePinnedExecute(r)
}

/*
CloudServiceChangePinned Method for CloudServiceChangePinned

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serviceId
 @return ApiCloudServiceChangePinnedRequest
*/
func (a *CloudServiceApiService) CloudServiceChangePinned(ctx context.Context, serviceId string) ApiCloudServiceChangePinnedRequest {
	return ApiCloudServiceChangePinnedRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
...
// Execute executes the request
//  @return CloudChangePinnedResponse
func (a *CloudServiceApiService) CloudServiceChangePinnedExecute(r ApiCloudServiceChangePinnedRequest) (*CloudChangePinnedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CloudChangePinnedResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudServiceApiService.CloudServiceChangePinned")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/cloud/{service_id}/pin"
	localVarPath = strings.Replace(localVarPath, "{"+"service_id"+"}", url.PathEscape(parameterToString(r.serviceId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cloudChangePinnedRequest == nil {
		return localVarReturnValue, nil, reportError("cloudChangePinnedRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cloudChangePinnedRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiCloudServiceGetListRequest) Offset(offset int32) ApiCloudServiceGetListRequest {
	r.offset = &offset
	return r
}

func (r ApiCloudServiceGetListRequest) Limit(limit int32) ApiCloudServiceGetListRequest {
	r.limit = &limit
	return r
}

func (r ApiCloudServiceGetListRequest) Sort(sort string) ApiCloudServiceGetListRequest {
	r.sort = &sort
	return r
}

func (r ApiCloudServiceGetListRequest) Filter(filter string) ApiCloudServiceGetListRequest {
	r.filter = &filter
	return r
}

func (r ApiCloudServiceGetListRequest) View(view string) ApiCloudServiceGetListRequest {
	r.view = &view
	return r
}
