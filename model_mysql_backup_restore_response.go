...
// checks if the MysqlBackupRestoreResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlBackupRestoreResponse{}
...
func (o MysqlBackupRestoreResponse) ToMap() (map[string]interface{}, error) {
