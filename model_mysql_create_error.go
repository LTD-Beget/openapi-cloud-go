...
// checks if the MysqlCreateError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlCreateError{}
...
func (o MysqlCreateError) ToMap() (map[string]interface{}, error) {
