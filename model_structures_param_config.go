...
// checks if the StructuresParamConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresParamConfig{}
...
func (o StructuresParamConfig) ToMap() (map[string]interface{}, error) {
