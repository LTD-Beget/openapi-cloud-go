...
// checks if the PostgresqlBackupRestoreResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlBackupRestoreResponse{}
...
func (o PostgresqlBackupRestoreResponse) ToMap() (map[string]interface{}, error) {
