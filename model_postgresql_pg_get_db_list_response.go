...
// checks if the PostgresqlPgGetDbListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgGetDbListResponse{}
...
func (o PostgresqlPgGetDbListResponse) ToMap() (map[string]interface{}, error) {
