...
// checks if the StructuresPostgresqlCopy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresPostgresqlCopy{}
...
func (o StructuresPostgresqlCopy) ToMap() (map[string]interface{}, error) {
