...
// checks if the PostgresqlPgUpdateRemoteAccessRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgUpdateRemoteAccessRequest{}
...
func (o PostgresqlPgUpdateRemoteAccessRequest) ToMap() (map[string]interface{}, error) {
