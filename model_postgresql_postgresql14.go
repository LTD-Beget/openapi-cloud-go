...
// checks if the PostgresqlPostgresql14 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPostgresql14{}
...
func (o PostgresqlPostgresql14) ToMap() (map[string]interface{}, error) {
