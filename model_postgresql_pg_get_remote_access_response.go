...
// checks if the PostgresqlPgGetRemoteAccessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgGetRemoteAccessResponse{}
...
func (o PostgresqlPgGetRemoteAccessResponse) ToMap() (map[string]interface{}, error) {
