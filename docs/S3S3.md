...
**AttachedCdn** | Pointer to [**S3S3Cdn**](S3S3Cdn.md) |  | [optional] 
...
`func (o *S3S3) GetAttachedCdn() S3S3Cdn`

GetAttachedCdn returns the AttachedCdn field if non-nil, zero value otherwise.

### GetAttachedCdnOk

`func (o *S3S3) GetAttachedCdnOk() (*S3S3Cdn, bool)`

GetAttachedCdnOk returns a tuple with the AttachedCdn field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAttachedCdn

`func (o *S3S3) SetAttachedCdn(v S3S3Cdn)`

SetAttachedCdn sets AttachedCdn field to given value.

### HasAttachedCdn

`func (o *S3S3) HasAttachedCdn() bool`

HasAttachedCdn returns a boolean if a field has been set.
