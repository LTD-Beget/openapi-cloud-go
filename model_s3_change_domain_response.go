...
// checks if the S3ChangeDomainResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ChangeDomainResponse{}
...
func (o S3ChangeDomainResponse) ToMap() (map[string]interface{}, error) {
