...
// checks if the MysqlSetConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlSetConfigResponse{}
...
func (o MysqlSetConfigResponse) ToMap() (map[string]interface{}, error) {
