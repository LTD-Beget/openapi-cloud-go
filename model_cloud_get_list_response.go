...
// checks if the CloudGetListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudGetListResponse{}
...
func (o CloudGetListResponse) ToMap() (map[string]interface{}, error) {
