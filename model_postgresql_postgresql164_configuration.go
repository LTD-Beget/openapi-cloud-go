...
// checks if the PostgresqlPostgresql164Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPostgresql164Configuration{}

// PostgresqlPostgresql164Configuration struct for PostgresqlPostgresql164Configuration
type PostgresqlPostgresql164Configuration struct {
...
func NewPostgresqlPostgresql164Configuration() *PostgresqlPostgresql164Configuration {
	this := PostgresqlPostgresql164Configuration{}
	return &this
}
...
func (o *PostgresqlPostgresql164Configuration) SetCpuCount(v int32) {
	o.CpuCount = &v
}
...
func (o PostgresqlPostgresql164Configuration) MarshalJSON() ([]byte, error) {
...
func (o PostgresqlPostgresql164Configuration) ToMap() (map[string]interface{}, error) {
...
type NullablePostgresqlPostgresql164Configuration struct {
	value *PostgresqlPostgresql164Configuration
	isSet bool
}

func (v NullablePostgresqlPostgresql164Configuration) Get() *PostgresqlPostgresql164Configuration {
	return v.value
}

func (v *NullablePostgresqlPostgresql164Configuration) Set(val *PostgresqlPostgresql164Configuration) {
	v.value = val
	v.isSet = true
}

func (v NullablePostgresqlPostgresql164Configuration) IsSet() bool {
	return v.isSet
}

func (v *NullablePostgresqlPostgresql164Configuration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostgresqlPostgresql164Configuration(val *PostgresqlPostgresql164Configuration) *NullablePostgresqlPostgresql164Configuration {
	return &NullablePostgresqlPostgresql164Configuration{value: val, isSet: true}
}

func (v NullablePostgresqlPostgresql164Configuration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostgresqlPostgresql164Configuration) UnmarshalJSON(src []byte) error {
	v.isSet = true
