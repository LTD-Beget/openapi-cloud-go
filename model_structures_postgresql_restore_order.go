...
// checks if the StructuresPostgresqlRestoreOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresPostgresqlRestoreOrder{}
...
func (o StructuresPostgresqlRestoreOrder) ToMap() (map[string]interface{}, error) {
