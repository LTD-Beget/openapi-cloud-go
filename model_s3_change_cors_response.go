...
// checks if the S3ChangeCorsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ChangeCorsResponse{}
...
func (o S3ChangeCorsResponse) ToMap() (map[string]interface{}, error) {
