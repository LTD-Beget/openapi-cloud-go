...
// checks if the PostgresqlPgUpdateDbResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgUpdateDbResponseError{}
...
func (o PostgresqlPgUpdateDbResponseError) ToMap() (map[string]interface{}, error) {
