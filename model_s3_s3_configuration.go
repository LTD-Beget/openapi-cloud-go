...
// checks if the S3S3Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3S3Configuration{}
...
func (o S3S3Configuration) ToMap() (map[string]interface{}, error) {
