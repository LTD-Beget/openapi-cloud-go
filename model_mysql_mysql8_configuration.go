...
// checks if the MysqlMysql8Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlMysql8Configuration{}

// MysqlMysql8Configuration struct for MysqlMysql8Configuration
type MysqlMysql8Configuration struct {
...
func (o MysqlMysql8Configuration) MarshalJSON() ([]byte, error) {
...
func (o MysqlMysql8Configuration) ToMap() (map[string]interface{}, error) {
...
type NullableMysqlMysql8Configuration struct {
	value *MysqlMysql8Configuration
	isSet bool
}

func (v NullableMysqlMysql8Configuration) Get() *MysqlMysql8Configuration {
	return v.value
}

func (v *NullableMysqlMysql8Configuration) Set(val *MysqlMysql8Configuration) {
	v.value = val
	v.isSet = true
}

func (v NullableMysqlMysql8Configuration) IsSet() bool {
	return v.isSet
}

func (v *NullableMysqlMysql8Configuration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMysqlMysql8Configuration(val *MysqlMysql8Configuration) *NullableMysqlMysql8Configuration {
	return &NullableMysqlMysql8Configuration{value: val, isSet: true}
}

func (v NullableMysqlMysql8Configuration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMysqlMysql8Configuration) UnmarshalJSON(src []byte) error {
	v.isSet = true
