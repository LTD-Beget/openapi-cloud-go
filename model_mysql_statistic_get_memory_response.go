...
// checks if the MysqlStatisticGetMemoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetMemoryResponse{}
...
func (o MysqlStatisticGetMemoryResponse) ToMap() (map[string]interface{}, error) {
