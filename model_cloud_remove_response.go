...
// checks if the CloudRemoveResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudRemoveResponse{}
...
func (o CloudRemoveResponse) ToMap() (map[string]interface{}, error) {
