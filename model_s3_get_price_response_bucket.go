...
// checks if the S3GetPriceResponseBucket type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3GetPriceResponseBucket{}
...
func (o S3GetPriceResponseBucket) ToMap() (map[string]interface{}, error) {
