...
// checks if the MysqlRemoveDbResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlRemoveDbResponse{}
...
func (o MysqlRemoveDbResponse) ToMap() (map[string]interface{}, error) {
