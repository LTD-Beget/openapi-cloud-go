...
// checks if the MysqlStatisticGetNetworkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetNetworkResponse{}
...
func (o MysqlStatisticGetNetworkResponse) ToMap() (map[string]interface{}, error) {
