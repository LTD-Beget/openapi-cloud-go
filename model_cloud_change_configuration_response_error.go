...
// checks if the CloudChangeConfigurationResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudChangeConfigurationResponseError{}
...
func (o CloudChangeConfigurationResponseError) ToMap() (map[string]interface{}, error) {
