...
// checks if the MysqlCreateDbResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlCreateDbResponse{}
...
func (o MysqlCreateDbResponse) ToMap() (map[string]interface{}, error) {
