...
// checks if the MysqlStatisticGetCpuDetailsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlStatisticGetCpuDetailsResponse{}
...
func (o MysqlStatisticGetCpuDetailsResponse) ToMap() (map[string]interface{}, error) {
