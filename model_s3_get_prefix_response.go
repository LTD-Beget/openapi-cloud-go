...
// checks if the S3GetPrefixResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3GetPrefixResponse{}
...
func (o S3GetPrefixResponse) ToMap() (map[string]interface{}, error) {
