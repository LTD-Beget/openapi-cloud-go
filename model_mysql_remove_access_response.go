...
// checks if the MysqlRemoveAccessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlRemoveAccessResponse{}
...
func (o MysqlRemoveAccessResponse) ToMap() (map[string]interface{}, error) {
