...
// checks if the MysqlDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MysqlDb{}
...
func (o MysqlDb) ToMap() (map[string]interface{}, error) {
