...
// checks if the PostgresqlStatisticGetDiskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlStatisticGetDiskResponse{}
...
func (o PostgresqlStatisticGetDiskResponse) ToMap() (map[string]interface{}, error) {
