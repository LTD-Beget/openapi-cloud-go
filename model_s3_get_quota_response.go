...
type S3GetQuotaResponse struct {
	...
	AvailableSize *int32 `json:"available_size,omitempty"`
}
...
// SetAvailableSize gets a reference to the given int32 and assigns it to the AvailableSize field.
...
func (o S3GetQuotaResponse) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.AvailableSize) {
		toSerialize["available_size"] = o.AvailableSize
	}
