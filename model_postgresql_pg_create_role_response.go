...
// checks if the PostgresqlPgCreateRoleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresqlPgCreateRoleResponse{}
...
func (o PostgresqlPgCreateRoleResponse) ToMap() (map[string]interface{}, error) {
