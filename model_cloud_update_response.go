...
// checks if the CloudUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudUpdateResponse{}
...
func (o CloudUpdateResponse) ToMap() (map[string]interface{}, error) {
